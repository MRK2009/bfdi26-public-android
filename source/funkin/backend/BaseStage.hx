...
class BaseStage extends FlxBasic
{
	...
	public var vpadCam(get, never):FlxCamera;
	public var camControls(get, never):FlxCamera;
	...
	inline private function get_vpadCam():FlxCamera return game.vpadCam;
	inline private function get_camControls():FlxCamera return game.camControls;
